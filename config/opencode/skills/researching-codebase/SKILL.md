...
- `thoughts-analyzer`: Extract key insights from specific documents (most relevant ones only)
...
```bash
./.claude/skills/researching-codebase/scripts/spec_metadata.sh
```
...
- With ticket: `thoughts/shared/research/YYYY-MM-DD-ENG-XXXX-description.md`
...
- thoughts-locator: "Find any existing documentation about authentication"
...
thoughts/shared/research/2025-10-23-authentication-flow.md
...
- [ ] thoughts/ paths corrected (searchable/ removed, structure preserved)
